...
import 'package:harcapp_core_own_song/page_widgets/song_part_editor_template/errors.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Stack(
            children: [
              ...
              Consumer2<ChordsProvider, TextProvider>(
                  builder: (context, chordsProvider, textProvider, child) => TextFieldFitChords(
                      style: TextStyle(
                        fontFamily: 'Roboto',
                        fontSize: Dimen.TEXT_SIZE_NORMAL,
                        color: textEnab_(context),
                      ...
                      onChanged: (text) => chordsProvider.chords = text,
                      controller: chordsProvider.controller
                  )
              ),
            ],
          ),
